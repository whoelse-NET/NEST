...
namespace Nest
{
	...
	public interface IRawElasticClient
	{
		...
		ConnectionStatus AliasesExistHead(string name, NameValueCollection queryString = null);

		///<summary>HEAD /_alias/{name}</summary>
		Task<ConnectionStatus> AliasesExistHeadAsync(string name, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/_alias/{name}</summary>
		ConnectionStatus AliasesExistHead(string index, string name, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/_alias/{name}</summary>
		Task<ConnectionStatus> AliasesExistHeadAsync(string index, string name, NameValueCollection queryString = null);
		...
		ConnectionStatus Head(string index, string type, string id, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/{type}/{id}</summary>
		Task<ConnectionStatus> HeadAsync(string index, string type, string id, NameValueCollection queryString = null);

		///<summary>HEAD /_template/{name}</summary>
		ConnectionStatus HeadIndexTemplate(string name, NameValueCollection queryString = null);

		///<summary>HEAD /_template/{name}</summary>
		Task<ConnectionStatus> HeadIndexTemplateAsync(string name, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/{type}/{id}/_source</summary>
		ConnectionStatus HeadSource(string index, string type, string id, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/{type}/{id}/_source</summary>
		Task<ConnectionStatus> HeadSourceAsync(string index, string type, string id, NameValueCollection queryString = null);
		...
		ConnectionStatus MainHead(NameValueCollection queryString = null);

		///<summary>HEAD /</summary>
		Task<ConnectionStatus> MainHeadAsync(NameValueCollection queryString = null);
		...
		ConnectionStatus TypesExistsHead(string index, string type, NameValueCollection queryString = null);

		///<summary>HEAD /{index}/{type}</summary>
		Task<ConnectionStatus> TypesExistsHeadAsync(string index, string type, NameValueCollection queryString = null);
